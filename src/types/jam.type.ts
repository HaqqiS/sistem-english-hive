...
export type TypeJam = RouterOutputs["jam"]["getAll"][number];
...
export const clientJamSchema = baseJamObject.superRefine((data, ctx) => {
...
export type TypeClientJamSchema = z.infer<typeof clientJamSchema>;
